...
class BubbleBackground extends React.Component {
  ...
  updateCanvas() {
    ...
    canvasBG.width = this.canvasContainer.clientWidth;
    canvasBG.height = this.canvasContainer.clientHeight;
...
//rendering function
  ...
  render() {
    return(
      <React.Fragment>
        <div ref={(ref) => this.canvasContainer = ref} className="canvas-container">
          <canvas id="canvas" className="canvas" ref={(ref) => this.canvas = ref} width="100%" height="100%"/>
          <canvas id="canvasbg" className="canvasBG" ref={(ref) => this.canvasbg = ref } width="100%" height="100%"/>
        </div>
